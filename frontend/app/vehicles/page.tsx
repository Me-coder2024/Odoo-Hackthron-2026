    ...
    <div>
      ...
      {showForm && (
        <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 8, padding: 24, marginBottom: 20, boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
          ...
          <form onSubmit={handleCreate} className="three-col-form">
            ...
            <div style={{ gridColumn: 'span 3', display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 8 }}>
              ...
              <button type="submit" style={{ padding: '8px 16px', backgroundColor: '#1542C2', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 13, fontWeight: 600 }}>Create Vehicle</button>
            </div>
          </form>
        </div>
      )}
